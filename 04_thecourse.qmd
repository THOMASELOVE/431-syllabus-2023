...
- The [Course Calendar](https://thomaselove.github.io/431-2023/calendar.html) provides additional detail on specific sessions, and links to materials used in those sessions, including slides.
...
- Using Quarto
    - Building Quarto documents within R Projects
    - Building R code using Quarto, and publishing/sharing results
