...
Professor Love maintains a set of [Course Notes](https://thomaselove.github.io/431-notes/). Professor Love revises the Notes every year, and so they appear in pieces as the semester progresses.
...
- You are welcome to read this book before class starts, if you'd like to get a jump on things, but that's not necessary: we'll link readings to the [Course Calendar](https://thomaselove.github.io/431-2023/calendar.html).

## Other Books to Download

There are two additional **free** books that you will definitely need to obtain during the semester and may be interested in looking at before class begins. Simply visit the links below.

1. [R for Data Science](https://r4ds.hadley.nz/) (2nd edition) by Hadley Wickham, Mine Cetinkaya-Rundel and Garrett Grolemund.
2. [Biostatistics for Biomedical Research](https://hbiostat.org/bbr/) by Frank E. Harrell Jr. The related set of YouTube videos can be found [here](https://www.youtube.com/channel/UC-o_ZZ0tuFUYn8e8rf-QURA).

In addition, the book [OpenIntro Statistics](https://www.openintro.org/book/os/) by David Diez, Mine Cetinkaya-Rundel, Christopher Barr and OpenIntro is also available for free, and has been very useful to some students in past versions of this course. I recommend it heartily.
