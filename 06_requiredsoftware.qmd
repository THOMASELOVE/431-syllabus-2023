...
R is free, but it can sometimes be a pain to install and configure. Information about getting R and RStudio on your computer is provided below, and [also on our main website](https://thomaselove.github.io/431-2023/software.html).
...
These instructions are also available on [the Software page](https://thomaselove.github.io/431-2023/software.html) at our main course website: <https://thomaselove.github.io/431-2023/>.

## Installing R and R Studio

The steps you need to complete are:

1. Download and install **the latest version of R** (version **4.3.1 or later**) from <https://cran.case.edu/> or, if you prefer, from <https://cloud.r-project.org/>, which automatically chooses a fast, nearby mirror for you.
    - If you have a pre-existing installation of R and/or RStudio, you will need to re-install both to get current.
2. Download and install **RStudio Desktop** (Open Source Edition - the free version **2023.06.1+524 or later**) by visiting <https://posit.co/download/rstudio-desktop/>. 
