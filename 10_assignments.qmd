...
There will be an (optional) bonus assignment called Lab X, which involves building a website for yourself. See the [Lab X instructions](https://github.com/THOMASELOVE/431-labs-2023) for more details.
