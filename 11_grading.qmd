...
The seven Main Labs are graded by the Teaching Assistants, according to a rubric and answer sketch. In grading labs, everything counts, including the quality of the presentation, as well as the coding and statistical work. Grading for Lab X will be discussed as part of the Lab X instructions, but completion of Lab X can only help your grade in the course.
